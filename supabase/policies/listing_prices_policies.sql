...
DROP POLICY IF EXISTS listing_prices_select_public ON public.listing_prices;
DROP POLICY IF EXISTS listing_prices_select_owner_or_admin ON public.listing_prices;

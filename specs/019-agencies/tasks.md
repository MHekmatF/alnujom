...
- [ ] T022 Update `supabase/docs/agencies.md` + `agency_members.md` + `agency_verification_requests.md` with the full RLS reader/writer matrix (data-model §1.14) + the `v_agencies` scoping + audit-trigger notes.

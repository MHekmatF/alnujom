...
- **Seven new SQL migration files** under `supabase/migrations/` named with synthetic-monotonic 14-digit timestamps `20260519120001` through `20260519120007`, ordered after Phase 9 (final Phase 9 migration on remote per T005 baseline: `20260518120007_phase9_fk_index_hardening`). The seven migrations:

...
- [ ] **⚠️ PARTIAL —** T034 [US5] Build the signed release APK and run a **binary secret-scan** of it (Phase 22 T046) — confirm **no** DSN / keystore / Vault / FCM-service-account material shipped — **acceptance (record outcome)**. Needs the signed APK (RB + keystore).
